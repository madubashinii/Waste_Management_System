...
export default function BinCard({ stop, index }) {
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                <h3 className="text-xl font-bold text-gray-900">{stop.bin_id}</h3>
                                {stop.collected ? (
                                ...
                                <div className="bg-blue-50 rounded-lg p-4 border-2 border-blue-200">
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-blue-600 font-semibold">Click to view full size</p>
                                        </div>
                                    </div>
                                    <img
                                        src={stop.photo_url}
                                        alt={`Proof for ${stop.bin_id}`}
